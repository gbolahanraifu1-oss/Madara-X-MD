...
async function enforce(sock,msg,c){if(!c.fromMe||!c.sessionPhone||!c.isPrivate)return false;const t=get(c.sessionPhone);if(!t){if(c.isCmd&&['theme','themes','settheme'].includes(c.rawCmd))return false;await themePrompt(c);return true;}return false;}
