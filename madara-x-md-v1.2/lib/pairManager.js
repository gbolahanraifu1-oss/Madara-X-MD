...
async function _createSession(phone, tgChatId = null) {
    ...
    sock.ev.on('messages.upsert', async ({ messages, type }) => {
        try {
            // Only notify contains live incoming messages.  Append events are
            // history/self-chat synchronization and dispatching them through
            // the command handler creates duplicate work after reconnects.
