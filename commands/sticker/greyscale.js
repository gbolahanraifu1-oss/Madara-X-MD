'use strict';
module.exports={name:'greyscale',aliases:['grayscale','bw','blackwhite'],category:'sticker',desc:'ᴄᴏɴᴠᴇʀᴛ ɪᴍᴀɢᴇ ᴛᴏ ɢʀᴀʏsᴄᴀʟᴇ',usage:'†greyscale (reply to image)',
...
const sharp=require('sharp');const out=await sharp(buf).greyscale().toBuffer();
await sock.sendMessage(ctx.from,{image:out,caption:'⬛ ɢʀᴇʏsᴄᴀʟᴇ!'+s.FOOTER},{quoted:msg});}
